...
<html lang="en">
  ...
  <body>
    ...
    <div class="container">
      <div class="row">
        <h1 style="margin-top: 150px; ">Kategori</h1>
        ...
        <div class="col-md-4">
          <div style="width: 355px; height: 200px; filter: brightness(.9); background: url(img/1.jpg); border-radius: 20px; margin-top:15px; background-size: cover;">
            <h1 style="color: white; text-shadow: 2px 2px 8px rgba(100,100,100,.5); font-size: 54px; text-align: center; line-height: 3.7; font-weight: 700; ">Sky</h1>
          </div>
        </div>
        <!-- Image 2 -->
        <div class="col-md-4">
