    ...
    <style type="text/css">
      ...
      *{
      ...
      .banner{
        ...
        width: 100%;
        height:84vh;
        background: url(img/home_img/4.jpg);
      ...
      .input{
        height: 50px; font-size: 20px; width: 290%; float: left; padding: 0; margin: 0; padding-left: 20px; opacity: 0;
      ...
      <div class="container-fluid">
        ...
        <div class="collapse navbar-collapse justify-content-end" id="navbarSupportedContent">
          <ul class="navbar-nav justify-content-end">
            ...
            <li class="nav-item">
              <a class="nav-link btn btn-primary" href="join.php" style="width: 80px; margin-right: 20px;margin-top: 6px;">Join</a>
            </li>
          </ul>
        </div>
      </div>
